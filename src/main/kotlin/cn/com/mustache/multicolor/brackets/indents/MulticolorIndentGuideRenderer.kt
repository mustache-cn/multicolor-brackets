...
import cn.com.mustache.multicolor.brackets.util.*
...
class MulticolorIndentGuideRenderer(val rangesWithMulticolorInfo: MutableMap<TextRange, cn.com.mustache.multicolor.brackets.MulticolorInfo?>) :
    ...
    override fun paint(editor: Editor, highlighter: RangeHighlighter, g: Graphics) {
        ...
        val multicolorInfo = rangesWithMulticolorInfo.getOrDefault(highlighter.textRange, null) ?: return
        ...
        g.color = if (selected) {
            multicolorInfo.color
        } else {
            val defaultBackground = editor.colorsScheme.defaultBackground
            multicolorInfo.color.alphaBlend(defaultBackground, 0.2f)
        }
